function [X_mainfold,stableVector] = calculateStableMainfoldPerturbation(periodo,X,mu,k,epsilon,signo,plotGraph,Ap,theta,Cr,Area,mass)
%calculateStableMainfoldPerturbation calcula el stable mainfold de una orbita
